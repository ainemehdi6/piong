    ...
    <>
      <div className="mx-36 my-16 h-[100-vh] flex flex-row shadow-md">
        <div className="h-full w-6/12 py-8 px-12 bg-xlight-gray">
          <h2 className="text-lg w-full text-center pb-4">Un Message à nous faire parvenir?</h2>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="placeholder-dark-gray  text-sm rounded-lg focus:outline-none focus:placeholder-light-gray block w-full ps-10 p-2.5"
          ...
          <textarea
            id="email-address-icon"
            className="placeholder-dark-gray h-[25vh] text-sm rounded-lg focus:outline-none focus:placeholder-light-gray block w-full p-3"
            placeholder="Bonjour..."
          />
